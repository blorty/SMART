...
categories = {
    "Physical": 
        [
            ...
            {"name": "Look for Humor", "description": "Seek laughter to lighten mood and reduce stress."},
            ...
            {"name": "Get Outside", "description": "Engage with nature to uplift spirits and reduce stress."},
    ...
    "Mental": 
        [
            ...
            {"name": "Ask for Help", "description": "Seek assistance when overwhelmed or unsure."},
            {"name": "Delegate Tasks", "description": "Distribute responsibilities to manage workload."},
            {"name": "Say No", "description": "Reserve the right to decline requests or opportunities."},
            {"name": "Limit Multitasking", "description": "Focus on one task at a time to improve efficiency."},
            {"name": "Avoid Negativity", "description": "Surround oneself with positive influences."},
    ...
    "Emotional": 
        [
            ...
            {"name": "Limit Interruptions", "description": "Establish periods of focused work without distractions."},
            {"name": "Plan Ahead", "description": "Prepare for upcoming tasks to reduce last-minute stress."},
            {"name": "Stay Flexible", "description": "Adapt to changes and unexpected events gracefully."},
            {"name": "Accept Change", "description": "Embrace life's changes as opportunities for growth."},
            ...
            {"name": "Take a Bath", "description": "Relax in a warm bath to soothe muscles and the mind."},
        ],

    "Social": 
        [
            {"name": "Use Essential Oils", "description": "Engage the senses with calming or invigorating scents."},
            {"name": "Limit Clutter", "description": "Maintain a tidy environment for clarity and peace of mind."},
    ...
    "Nutritional": 
        [
            ...
            {"name": "Listen to Nature Sounds", "description": "Tune into calming sounds to relax."},
            {"name": "Go for a Drive", "description": "Take a scenic drive for a change of scenery."},
            {"name": "Hug Someone", "description": "Physical touch to connect and comfort."},
            {"name": "Hold Hands", "description": "A simple gesture of connection and support."},
            {"name": "Kiss Someone", "description": "Express affection and strengthen bonds."},
            {"name": "Practice Good Posture", "description": "Maintain alignment to reduce physical stress."},
            {"name": "Smile", "description": "A simple act to elevate mood."},
            {"name": "Look for the Good", "description": "Seek positivity in every situation."},
            {"name": "Set Goals", "description": "Outline aspirations to give direction."},
            {"name": "Practice Time Management", "description": "Organize tasks to optimize productivity."},
            ...
            {"name": "Avoid Comparison", "description": "Appreciate one's unique journey without measuring against others."},
